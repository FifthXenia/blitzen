...
#+end_src
- If you're not using straight, you're probably going to have to manually set the paths for the ~schizophrenia-start-sound~, as it's currently set to a straight-dependent path: ~"../../repos/schizophrenia/sounds/org.gnome.Solanum-beep.ogg"~.
** Dependencies
